...
def _product_readiness_checks() -> list[ProductReadinessCheck]:
    ...
    return [
        ...
        _check("production_vendor_access_ready", "Production vendor access ready", "fail", "production", "Vendor access is demo-safe but not production lifecycle complete.", "Finish token lifecycle, invitation, revocation, monitoring, and support controls."),
