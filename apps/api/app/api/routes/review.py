...
from app.core.schemas import CurrentUserContext, HumanReviewCorrectionRequest, HumanReviewTask, Permission
...
def submit_review_corrections(
    ...
    return review_agent.submit_corrections(task_id, payload)
